...
export default function ViewCartBar() {
  ...
  return (
    <div className="mx-auto fixed bottom-0 mb-[10px] left-0 right-0 z-50 w-full max-w-[620px] px-4 sm:px-6 py-4 bg-blue-600 rounded-lg flex justify-between items-center">
